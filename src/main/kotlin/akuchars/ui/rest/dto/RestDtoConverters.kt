...
import akuchars.ui.rest.dto.ProductColorRestDto.BLACK
import akuchars.ui.rest.dto.ProductColorRestDto.YELLOW
...
fun ProductDataRestDto.toDto(): ProductDataDto =
	ProductDataDto(
		id, name, colorDto.toDto(), amount
	)

fun ProductColorRestDto.toDto(): ProductColorDto =
	when (this) {
		BLACK -> ProductColorDto.BLACK
		YELLOW -> ProductColorDto.YELLOW
	}
